...
# sounds
gameOverSound = pygame.mixer.Sound("imusic/crash.wav")
pygame.mixer.music.load("imusic/car.wav")
laugh = pygame.mixer.Sound("imusic/laugh.wav")
...
while count > 0:
    ...
    while True:  # the game loop
        score += random.randint(1, 100)  # increase score
        ...
        if baddieAddCounter == ADDNEWBADDIERATE:
            ...
            newBaddie = {
                ...
                "speed": random.randint(BADDIEMINSPEED, BADDIEMAXSPEED) + score,
