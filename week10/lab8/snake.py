...
while True:
    ...
    if snakePosition[0] == fruit_position[0] and snakePosition[1] == fruit_position[1]:
    ...
    if snakePosition[0] < 0 or snake_position[0] > window_x - 10:
        game_over()
    if snakePosition[1] < 0 or snake_position[1] > window_y - 10:
        game_over()

    # Touching the snake body
    for block in snakebody[1:]:
        if snakePosition[0] == block[0] and snake_position[1] == block[1]:
            game_over()
